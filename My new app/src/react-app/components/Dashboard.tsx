...
// import { TrendingUp, CheckCircle, Flame, Trophy } from 'lucide-react';

// const MOTIVATIONAL_QUOTES = [
//   "Every expert was once a beginner—you're becoming one!",
...
//     { id: '1', name: 'Morning Meditation', endGoal: '30 minutes daily', targetTime: '06:00', streak: 7, category: 'Wellness' },
//     { id: '2', name: 'Reading', endGoal: '30 pages daily', targetTime: '20:00', streak: 14, category: 'Learning' },
//     { id: '3', name: 'Exercise', endGoal: '45 minutes workout', targetTime: '07:00', streak: 5, category: 'Fitness' },
//     { id: '4', name: 'Journaling', endGoal: '10 minutes reflection', targetTime: '21:00', streak: 3, category: 'Mindfulness' },
//   ]);
...
//   const stats = [
//     { label: 'Active Habits', value: habits.length, icon: CheckCircle, color: 'from-teal-500 to-emerald-500' },
//     { label: 'Total Streaks', value: habits.reduce((sum, h) => sum + h.streak, 0), icon: Flame, color: 'from-orange-500 to-rose-500' },
//     { label: 'Achievements', value: 12, icon: Trophy, color: 'from-purple-500 to-indigo-500' },
//     { label: 'Success Rate', value: '85%', icon: TrendingUp, color: 'from-blue-500 to-cyan-500' },
//   ];
...
//           className={`text-center mb-8 p-8 rounded-2xl shadow-lg backdrop-blur-sm ${
//             isDarkMode 
//               ? 'bg-gradient-to-br from-gray-800/50 to-slate-800/50 border border-gray-700' 
//               : 'bg-gradient-to-br from-white to-blue-50'
//           }`}
//         >
//           <p className={`text-2xl font-medium italic ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>
...
//                     {habit.category}
//                   </span>
//                   <h3 className={`font-bold text-lg mt-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
//                     {habit.name}
//                   </h3>
...
//                 <span>•</span>
//                 <span className="font-semibold text-orange-500">{habit.streak} day streak</span>
//               </div>
//             </motion.div>
//           ))}
//         </div>
